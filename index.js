...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["62815150192842@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["62815150192842@s.whatsapp.net"]
			const frendsowner = ["6282230917988@s.whatsapp.net"]
			...
			switch(command) {
				...
				case 'epek':
					...
					break
				case 'info':
					client.sendMessage(from, info(prefix), text)
					break
				case 'blocklist':
				...
				case 'sticker':
					...
					break
			case 'creator':
                 client.sendMessage(from, {displayname: "Lynn", vcard: vcard}, MessageType.contact, { quoted: mek})
				...
				if (!isGroup) return reply(mess.only.group)
					...
					teks += `*Nama grup ▣͜͡➢ * ${groupName}\n*Deskripsi ▣͜͡➢ * ${groupDesc}\n*Jumlah Admin ▣͜͡➢ * ${groupAdmins.length}\n*Jumlah Member ▣͜͡➢ * ${groupMembers.length}`
					no = 0
		        ...
		        client.sendMessage(from, buffer, image, {quoted: mek, caption: `*NAME* ▣͜͡➢ ${groupName}\n*MEMBER* ▣͜͡➢ ${groupMembers.length}\n*ADMIN* ▣͜͡➢ ${groupAdmins.length}\n*DESK* ▣͜͡➢ ${groupDesc}`})
                break
				case 'testime':
					setTimeout( () => {
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
				...
				case 'donate':
					...
					break
                case 'tes':
                   client.sendMessage(from, 'Hai Slur:v', text, {quoted: mek})
                case 'ttp':
                ...
                case 'report':
                    ...
                    client.sendMessage('62815150192842@s.whatsapp.net', options, text, {quoted: mek})
				...
				case 'wibu':
					...
					wibu = ` ▣͜͡➢ *nama* ${anu.result.nama} ▣͜͡➢ *deskripsi* ${anu.result.deskripsi}`
               ...
               case 'infogempa':
                ...
                case 'tebakgambar':
					...
					setTimeout( () => {
					client.sendMessage(from, '*▣͜͡➢ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                case 'caklontong':
					...
					setTimeout( () => {
					client.sendMessage(from, '*▣͜͡➢ Jawaban :* '+anu.result.jawaban+'\n'+anu.result.desk, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
			    ...
			    case 'igstalk':
					...
					capt = `User Ditemukan!!\n\n*▣͜͡➢ Nama :* ${anu.result.full_name}\n*▣͜͡➢ Username :* ${anu.result.username}\n*▣͜͡➢ Followers :* ${anu.result.follower}\n*▣͜͡➢ Mengikuti :* ${anu.result.follow}\n*▣͜͡➢ Jumlah Post :* ${anu.result.post_count}\n*▣͜͡➢ Private :* ${anu.result.is_private}\n*▣͜͡➢ Bio :* ${anu.result.biography}`
				...
				case 'infomobil':
					...
					capt = `mobil Ditemukan!!\n\n*▣͜͡➢ title :* ${anu.result.title}\n*▣͜͡➢ harga :* ${anu.result.harga}\n*▣͜͡➢ kekurangan :* ${anu.result.kekurangan}\n*▣͜͡➢ kelebihan :* ${anu.result.kelebihan}`
					client.sendMessage(from, buffer, image, {quoted: mek, caption: capt})
					break
				case 'infomotor':
					...
					buffer = await getBuffer(anu.result.image)
					cptr = `motor Ditemukan!!\n\n*▣͜͡➢ title :* ${anu.result.title}\n*▣͜͡➢ harga :* ${anu.result.harga}\n*▣͜͡➢ spesifikasi :* ${anu.result.spesifikasi}\n*▣͜͡➢ kekurangan :* ${anu.result.kekurangan}\n*▣͜͡➢ kelebihan :* ${anu.result.kelebihan}`
				...
				case 'playstore':
					...
					capty = `*▣͜͡➢ title :* ${anu.title}\n*▣͜͡➢ app_id :* ${anu.app_id}\n*▣͜͡➢ description :* ${anu.description}\n*▣͜͡➢ developer_id :* ${anu.developer_id}\n*▣͜͡➢ developer :* ${anu.developer}\n*▣͜͡➢ score :* ${anu.score}\n*▣͜͡➢ full_price :* ${anu.full_price}\n*▣͜͡➢ price :* ${anu.price}\n*▣͜͡➢ free :* ${anu.free}`
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 *Mention All* 〙✪══'+teks+'╚═〘 *Z-pLerx* 〙', members_id, true)
					break
				case 'clearall':
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `[ _*Z-pLerx Broadcast*_ ]\n\n${body.slice(4)}`})
						}
						reply('_Sukses broadcast slurrd_')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `[ _*Z-pLerx Broadcast*_ ]\n\n${body.slice(4)}`)
						}
						reply('_Sukses broadcast slurrd_')
					}
					break
